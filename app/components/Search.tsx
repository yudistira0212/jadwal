...
// ATAU pakai cara manual di bawah kalau tidak mau install library tambahan
...
export default function Search({ placeholder }: { placeholder: string }) {
  ...
  // Debouncing manual (agar tidak request ke server tiap ketik 1 huruf)
  // Kita pakai timeout sederhana
  ...
  return (
    <div className="relative flex flex-1 shrink-0">
      ...
      <input
        ...
        onChange={(e) => {
          // Tunggu 300ms setelah user berhenti mengetik baru eksekusi
